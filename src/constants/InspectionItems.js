export default [
    {
        question: "Todos os estágios do enxame e ínstares estão presentes em quantidade apropriadas? ",
        hasMetCondition: true
    },
    {
        question: "Existe abelhas\
     adultas e estrutura etária suficientes para cuidar da ninhada e \
     realizar todas as tarefas do colônia?", hasMetCondition: true
    },
    {
    ...
    {
        question: "Espaço adequado (nem muito nem pouco) para o tamanho da colônia atual?", hasMetCondition: true,
        subText: "Espaço esperado a curto prazo que seja higiênico, defensável e adequado para postura de ovos?"
    }
]